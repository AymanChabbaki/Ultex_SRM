...
function database() {
  return {
    clients: [
      { code: 'L100', nom: 'Workflow Today', sourceDonnees: 'Workflow', dateDerniereDemande: '2026-09-18', echeanceCode: '2026-09-18', dernierContact: '2026-09-10' },
      { code: 'L200', nom: 'Sheet Today', sourceDonnees: 'Google Sheets', dateDerniereDemande: '2026-09-18' },
      { code: 'L300', nom: 'Old Code', sourceDonnees: 'Workflow', dernierSuiviData: '2026-08-01', dernierContact: '2026-08-01' },
    ],
    demandes: [
      { code: 'D1', client: 'L100', codeClientUltex: 'L100', dateDemande: '2026-09-18', sourceSynchronisation: 'Workflow', objectifGeneral: 'Produit A', responsableData: 'Data', statut: 'Nouvelle' },
      ...
      { code: 'D3', client: 'L300', dateDemande: '2026-09-17', objectifGeneral: 'Ancien', responsableData: 'Data', statut: 'Nouvelle' },
    ],
