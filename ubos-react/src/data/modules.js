...
clients:{label:"Clients", ic:Building2, grp:"Commercial", coll:"clients", pfx:"C", statut:"segment",
 champs:[
  // Identité -- matches ONGLETS_360's "1. Identité" tab in FicheClient.jsx
  {k:"type",l:"Type",t:"select",opts:["Personne physique","Société"],groupe:"Identité"},
  {k:"nom",l:"Nom / Raison sociale",t:"text",req:1,groupe:"Identité"},
  {k:"raisonSociale",l:"Raison sociale",t:"text",groupe:"Identité"},
  {k:"ice",l:"ICE",t:"text",groupe:"Identité"},
  {k:"idFiscal",l:"Identifiant fiscal (IF)",t:"text",groupe:"Identité"},
  {k:"rc",l:"RC",t:"text",groupe:"Identité"},
  {k:"cnss",l:"CNSS",t:"text",groupe:"Identité"},
  {k:"adresse",l:"Adresse",t:"text",groupe:"Identité"},
  {k:"ville",l:"Ville",t:"text",groupe:"Identité"},
  {k:"pays",l:"Pays",t:"pays",groupe:"Identité"},
  {k:"telephone",l:"Téléphone",t:"text",groupe:"Identité"},
  {k:"whatsapp",l:"WhatsApp",t:"text",groupe:"Identité"},
  {k:"email",l:"E-mail",t:"text",groupe:"Identité"},
  {k:"siteWeb",l:"Site web",t:"text",groupe:"Identité"},
  {k:"googleMaps",l:"Lien Google Maps",t:"text",groupe:"Identité"},
  {k:"gps",l:"Coordonnées GPS",t:"text",groupe:"Identité"},
  {k:"reseauxSociaux",l:"Réseaux sociaux",t:"text",groupe:"Identité"},
  ...
  {k:"codeClientUltex",l:"Code client ULTEX",t:"text",aide:"Laissez vide pour attribuer automatiquement le prochain code numérique (à partir de 9600). Un code ULTEX, L ou A saisi manuellement reste prioritaire.",groupe:"Identité"},
  ...
  {k:"activitePrincipale",l:"Activité principale",t:"text",groupe:"Profil commercial"},
  {k:"activiteSecondaire",l:"Activité secondaire",t:"text",groupe:"Profil commercial"},
  {k:"localCommercial",l:"Type de local",t:"select",opts:["Boutique","Entrepôt","Bureau","Usine","En ligne uniquement","Autre"],groupe:"Profil commercial"},
  {k:"marketplaceUtilisee",l:"Marketplace utilisée",t:"text",groupe:"Profil commercial"},
  {k:"nbEmployes",l:"Nombre d'employés",t:"number",groupe:"Profil commercial"},
  {k:"anneesExistence",l:"Années d'existence",t:"number",groupe:"Profil commercial"},
  {k:"caEstime",l:"CA estimé (MAD/an)",t:"number",groupe:"Profil commercial"},
  {k:"objectif",l:"Objectif du client",t:"textarea",groupe:"Profil commercial"},
  {k:"projetActuel",l:"Projet actuel",t:"textarea",groupe:"Profil commercial"},
  {k:"projetFutur",l:"Projet futur",t:"textarea",groupe:"Profil commercial"},
  {k:"produitsVendus",l:"Produits vendus",t:"textarea",groupe:"Profil commercial"},
  {k:"produitsSouhaites",l:"Produits souhaités",t:"textarea",groupe:"Profil commercial"},
  {k:"paysImport",l:"Pays d'import habituels",t:"text",groupe:"Profil commercial"},
  {k:"frequenceAchat",l:"Fréquence d'achat",t:"select",opts:["Ponctuelle","Mensuelle","Trimestrielle","Semestrielle","Annuelle","Irrégulière"],groupe:"Profil commercial"},
  {k:"budgetMoyen",l:"Budget moyen par commande (MAD)",t:"number",groupe:"Profil commercial"},
  {k:"urgence",l:"Urgence habituelle",t:"select",opts:["Faible","Normale","Élevée","Urgente"],groupe:"Profil commercial"},
  {k:"sourcePremierContact",l:"Source du premier contact",t:"select",opts:["Meta","Google","YouTube","WhatsApp","Téléphone","Site web","Référence","Salon","Autre"],groupe:"Profil commercial"},
  {k:"datePremierContact",l:"Date du premier contact",t:"date",groupe:"Profil commercial"},
  // Profil import -- "3. Profil import"
  {k:"niveauImport",l:"Niveau import",t:"select",opts:["Débutant","Intermédiaire","Expérimenté","Expert"],groupe:"Profil import"},
  {k:"nbImportations",l:"Nombre d'importations réalisées",t:"number",groupe:"Profil import"},
  {k:"incotermsConnus",l:"Incoterms connus",t:"select",opts:["Oui","Non","Partiellement"],groupe:"Profil import"},
  {k:"documentsConnus",l:"Documents connus",t:"select",opts:["Oui","Non","Partiellement"],groupe:"Profil import"},
  {k:"transportConnu",l:"Transport connu",t:"select",opts:["Oui","Non","Partiellement"],groupe:"Profil import"},
  {k:"douaneConnue",l:"Douane connue",t:"select",opts:["Oui","Non","Partiellement"],groupe:"Profil import"},
  {k:"certificationsConnues",l:"Certifications connues",t:"select",opts:["Oui","Non","Partiellement"],groupe:"Profil import"},
  {k:"historiquePays",l:"Historique pays (notes)",t:"textarea",groupe:"Profil import"},
  {k:"historiqueFournisseurs",l:"Historique fournisseurs (notes)",t:"textarea",groupe:"Profil import"},
  {k:"historiqueProduits",l:"Historique produits (notes)",t:"textarea",groupe:"Profil import"},
  {k:"preferencesFournisseurs",l:"Préférences fournisseurs",t:"textarea",groupe:"Profil import"},
  {k:"exigenceQualite",l:"Exigence qualité",t:"select",opts:["Économique","Moyen","Premium"],groupe:"Profil import"},
  {k:"marquesPreferees",l:"Marques préférées",t:"text",groupe:"Profil import"},
  {k:"budgetReel",l:"Budget réel constaté",t:"number",groupe:"Profil import"},
  {k:"produitsRetenus",l:"Produits retenus",t:"textarea",groupe:"Profil import"},
  // Comportemental -- "4. Comportemental"
  {k:"personnalite",l:"Personnalité",t:"text",groupe:"Comportemental"},
  {k:"vitesseDecision",l:"Décision",t:"select",opts:["Rapide","Normale","Lente"],groupe:"Comportemental"},
  {k:"communicationPreferee",l:"Communication préférée",t:"select",opts:["WhatsApp","Téléphone","Email","Visite","Autre"],groupe:"Comportemental"},
  {k:"heurePreferee",l:"Heure préférée",t:"text",groupe:"Comportemental"},
  {k:"langue",l:"Langue",t:"select",opts:["Arabe","Français","Anglais","Espagnol","Autre"],groupe:"Comportemental"},
  {k:"centresInteret",l:"Centres d'intérêt",t:"textarea",groupe:"Comportemental"},
  {k:"sensibilitePrix",l:"Sensibilité au prix",t:"select",opts:["Faible","Moyenne","Élevée"],groupe:"Comportemental"},
  {k:"sensibiliteQualite",l:"Sensibilité qualité",t:"select",opts:["Faible","Moyenne","Élevée"],groupe:"Comportemental"},
  {k:"sensibiliteDelai",l:"Sensibilité délai",t:"select",opts:["Faible","Moyenne","Élevée"],groupe:"Comportemental"},
  {k:"objections",l:"Objections courantes",t:"textarea",groupe:"Comportemental"},
  {k:"pourquoiAchat",l:"Pourquoi il achète",t:"textarea",groupe:"Comportemental"},
  ...
  {k:"remarque",l:"Remarques",t:"textarea",large:1,groupe:"Suivi Data"}
 ],
...
demandes:{label:"Demandes", ic:ClipboardEdit, grp:"Commercial", coll:"demandes", pfx:"DMD", statut:"statut",
 champs:[
  {k:"client",l:"Client",t:"ref",coll:"clients",cle:"nom",req:1,groupe:"Client & origine"},
  {k:"codeClientUltex",l:"Code client ULTEX",t:"text",aide:"Synchronisé automatiquement depuis ULTEX.",groupe:"Client & origine"},
  {k:"dateDemande",l:"Date",t:"date",groupe:"Client & origine"},
  {k:"dateHeureReception",l:"Date et heure de réception",t:"text",aide:"Format libre si l'heure exacte est connue, ex. 05/08/2026 14:30.",groupe:"Client & origine"},
  {k:"responsableData",l:"Responsable Data",t:"select",opts:(DB)=>PERS_ET_SERVICES(DB),groupe:"Client & origine"},
  {k:"source",l:"Source",t:"select",opts:["Meta","Google","YouTube","WhatsApp","Téléphone","Site web","Référence","Salon","Autre"],groupe:"Client & origine"},
  {k:"canalReception",l:"Canal de réception",t:"select",opts:CANAUX_RECEPTION_DEMANDE,groupe:"Client & origine"},
  {k:"typeDemande",l:"Type de demande (ULTEX)",t:"select",opts:["Sourcing (B)","Proforma (A1)","Négociation (A2)"],groupe:"Projet & besoin"},
  {k:"sensOperation",l:"Sens de l'opération",t:"select",opts:["Import","Export","Accompagnement"],groupe:"Projet & besoin"},
  {k:"objectifGeneral",l:"Objet général de la demande",t:"textarea",groupe:"Projet & besoin"},
  {k:"typeProjet",l:"Type de projet",t:"select",opts:TYPES_PROJET_DEMANDE,groupe:"Projet & besoin"},
  {k:"urgence",l:"Urgence",t:"select",opts:["Faible","Normale","Élevée","Urgente"],groupe:"Projet & besoin"},
  {k:"budgetGlobalEstime",l:"Budget global estimé (MAD)",t:"number",groupe:"Projet & besoin"},
  {k:"dateSouhaiteeClient",l:"Date souhaitée par le client",t:"date",groupe:"Projet & besoin"},
  ...
  {k:"echeanceActionSuivante",l:"Échéance",t:"date",groupe:"Suivi & statut"}
 ],
...
demandeLignes:{label:"Lignes de demande", ic:ClipboardEdit, grp:"Commercial", coll:"demandeLignes", pfx:"DL", statut:"statut",
 champs:[
  {k:"demande",l:"Demande",t:"ref",coll:"demandes",cle:"code",req:1,groupe:"Circuit"},
  {k:"typeTraitement",l:"Type de traitement",t:"select",opts:TYPES_TRAITEMENT_LIGNE,req:1,aide:"Détermine le circuit (Sourcing, Études & Chiffrage, Réglementation, Transport…). UBOS propose une valeur, modifiable à tout moment.",groupe:"Circuit"},
  // Identification
  {k:"nomProduit",l:"Nom commercial du produit",t:"text",req:1,groupe:"Identification"},
  {k:"designationTechnique",l:"Désignation technique",t:"text",groupe:"Identification"},
  {k:"famille",l:"Famille de produit",t:"text",groupe:"Identification"},
  {k:"sousFamille",l:"Sous-famille",t:"text",groupe:"Identification"},
  {k:"usage",l:"Usage du produit",t:"textarea",groupe:"Identification"},
  {k:"secteurUtilisation",l:"Secteur d'utilisation",t:"text",groupe:"Identification"},
  {k:"description",l:"Description détaillée",t:"textarea",large:1,groupe:"Identification"},
  {k:"marqueSouhaitee",l:"Marque souhaitée",t:"text",groupe:"Identification"},
  {k:"modeleSouhaite",l:"Modèle souhaité",t:"text",groupe:"Identification"},
  {k:"reference",l:"Référence",t:"text",groupe:"Identification"},
  {k:"etatProduit",l:"Produit neuf ou occasion",t:"select",opts:["Neuf","Occasion"],groupe:"Identification"},
  {k:"destinationUsage",l:"Destiné à la revente ou à l'usage propre",t:"select",opts:["Revente","Usage propre"],groupe:"Identification"},
  {k:"lienProduit",l:"Lien produit (site fournisseur, marketplace…)",t:"text",groupe:"Identification"},
  {k:"photo",l:"Photo produit",t:"file",groupe:"Identification"},
  // Quantité & conditionnement
  {k:"quantite",l:"Quantité demandée",t:"number",groupe:"Quantité & conditionnement"},
  {k:"unite",l:"Unité",t:"select",opts:["Pièces","Kg","Tonnes","Litres","Mètres","Cartons","Lots","Autre"],groupe:"Quantité & conditionnement"},
  {k:"quantiteMin",l:"Quantité minimale acceptable",t:"number",groupe:"Quantité & conditionnement"},
  {k:"piecesParCarton",l:"Pièces par carton",t:"number",groupe:"Quantité & conditionnement"},
  {k:"nbCartons",l:"Nombre total de cartons",t:"number",aide:"Calculé automatiquement si vide : quantité ÷ pièces par carton.",groupe:"Quantité & conditionnement"},
  {k:"poidsNetPiece",l:"Poids net par pièce (kg)",t:"number",groupe:"Quantité & conditionnement"},
  {k:"poidsBrutCarton",l:"Poids brut par carton (kg)",t:"number",groupe:"Quantité & conditionnement"},
  {k:"poidsBrutTotal",l:"Poids brut total (kg)",t:"number",aide:"Calculé automatiquement si vide : cartons × poids par carton.",groupe:"Quantité & conditionnement"},
  {k:"cbmCarton",l:"Volume par carton (CBM)",t:"number",groupe:"Quantité & conditionnement"},
  {k:"cbmTotal",l:"Volume total (CBM)",t:"number",aide:"Calculé automatiquement si vide : cartons × CBM par carton.",groupe:"Quantité & conditionnement"},
  {k:"dimensionsCarton",l:"Dimensions d'un carton",t:"text",groupe:"Quantité & conditionnement"},
  {k:"typeEmballage",l:"Type d'emballage",t:"text",groupe:"Quantité & conditionnement"},
  {k:"palettise",l:"Palettisé",t:"select",opts:["Oui","Non"],groupe:"Quantité & conditionnement"},
  {k:"nbPalettes",l:"Nombre de palettes",t:"number",groupe:"Quantité & conditionnement"},
  {k:"empilable",l:"Empilable",t:"select",opts:["Oui","Non"],groupe:"Quantité & conditionnement"},
  {k:"fragile",l:"Fragile",t:"select",opts:["Oui","Non"],groupe:"Quantité & conditionnement"},
  {k:"marchandiseDangereuse",l:"Marchandise dangereuse",t:"select",opts:["Oui","Non"],groupe:"Quantité & conditionnement"},
  // Fournisseur & offre
  {k:"statutFournisseur",l:"Fournisseur",t:"select",opts:["Fournisseur connu","Nouveau fournisseur","À rechercher","Plusieurs fournisseurs disponibles","Client a son fournisseur"],groupe:"Fournisseur & offre"},
  {k:"fournisseur",l:"Fournisseur (si connu)",t:"ref",coll:"fournisseurs",cle:"nom",groupe:"Fournisseur & offre"},
  {k:"paysFournisseur",l:"Pays du fournisseur",t:"pays",groupe:"Fournisseur & offre"},
  {k:"adresseEnlevement",l:"Adresse d'enlèvement",t:"text",groupe:"Fournisseur & offre"},
  {k:"contactFournisseur",l:"Contact",t:"text",groupe:"Fournisseur & offre"},
  {k:"moq",l:"MOQ",t:"number",groupe:"Fournisseur & offre"},
  {k:"delaiProduction",l:"Délai de production",t:"text",groupe:"Fournisseur & offre"},
  {k:"conditionsPaiement",l:"Conditions de paiement",t:"text",groupe:"Fournisseur & offre"},
  {k:"validiteOffre",l:"Validité de l'offre",t:"date",groupe:"Fournisseur & offre"},
  {k:"quantiteDisponible",l:"Quantité disponible",t:"number",groupe:"Fournisseur & offre"},
  {k:"echantillonDisponible",l:"Échantillon disponible",t:"select",opts:["Oui","Non"],groupe:"Fournisseur & offre"},
  {k:"prixEchantillon",l:"Prix échantillon",t:"number",groupe:"Fournisseur & offre"},
  {k:"proforma",l:"Proforma Invoice",t:"file",groupe:"Fournisseur & offre"},
  {k:"ficheTechniqueFournisseur",l:"Fiche technique fournisseur",t:"file",groupe:"Fournisseur & offre"},
  {k:"commentairesOffre",l:"Commentaires sur l'offre",t:"textarea",groupe:"Fournisseur & offre"},
  // Prix & conditions commerciales
  {k:"prixUnitaire",l:"Prix unitaire fournisseur",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"devise",l:"Devise",t:"select",opts:["MAD","USD","EUR","CNY","GBP","AED"],groupe:"Prix & conditions commerciales"},
  {k:"montantMarchandise",l:"Montant total marchandise",t:"number",aide:"Calculé automatiquement si vide : prix unitaire × quantité.",groupe:"Prix & conditions commerciales"},
  {k:"incoterm",l:"Incoterm",t:"incoterm",groupe:"Prix & conditions commerciales"},
  {k:"lieuIncoterm",l:"Lieu précis de l'Incoterm",t:"text",groupe:"Prix & conditions commerciales"},
  {k:"modePaiementPropose",l:"Mode de paiement proposé",t:"text",groupe:"Prix & conditions commerciales"},
  {k:"acompteFournisseur",l:"Acompte fournisseur",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"soldeFournisseur",l:"Solde fournisseur",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"remise",l:"Remise éventuelle",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"fraisMoule",l:"Frais moule",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"fraisEmballage",l:"Frais emballage",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"fraisPersonnalisation",l:"Frais personnalisation",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"fraisDocuments",l:"Frais documents",t:"number",groupe:"Prix & conditions commerciales"},
  {k:"autresFrais",l:"Autres frais fournisseur",t:"number",groupe:"Prix & conditions commerciales"},
  // Origine & logistique
  {k:"paysOrigine",l:"Pays d'origine",t:"pays",groupe:"Origine & logistique"},
  {k:"villeFournisseur",l:"Ville fournisseur",t:"text",groupe:"Origine & logistique"},
  {k:"portProbable",l:"Port ou aéroport probable",t:"port",groupe:"Origine & logistique"},
  {k:"modeTransportSouhaite",l:"Mode de transport souhaité",t:"select",opts:["Maritime","Aérien","Routier","À étudier"],groupe:"Origine & logistique"},
  {k:"urgenceTransport",l:"Transport urgent ou normal",t:"select",opts:["Normal","Urgent"],groupe:"Origine & logistique"},
  {k:"marchandisePrete",l:"Marchandise prête ou en production",t:"select",opts:["Prête","En production"],groupe:"Origine & logistique"},
  {k:"dateMarchandisePrete",l:"Date marchandise prête",t:"date",groupe:"Origine & logistique"},
  {k:"besoinEnlevement",l:"Besoin d'enlèvement",t:"select",opts:["Oui","Non"],groupe:"Origine & logistique"},
  {k:"besoinTransportIntl",l:"Besoin de transport international",t:"select",opts:["Oui","Non"],groupe:"Origine & logistique"},
  {k:"besoinTransit",l:"Besoin de transit",t:"select",opts:["Oui","Non"],groupe:"Origine & logistique"},
  {k:"besoinLivraisonFinale",l:"Besoin de livraison finale",t:"select",opts:["Oui","Non"],groupe:"Origine & logistique"},
  // Technique
  {k:"matiere",l:"Matière / Composition",t:"text",groupe:"Technique"},
  {k:"dimensionsProduit",l:"Dimensions produit",t:"text",groupe:"Technique"},
  {k:"couleur",l:"Couleur",t:"text",groupe:"Technique"},
  {k:"puissanceVoltage",l:"Puissance / Voltage / Fréquence",t:"text",groupe:"Technique"},
  {k:"capaciteTechnologie",l:"Capacité / Technologie / Fonctionnement",t:"textarea",groupe:"Technique"},
  {k:"normesAnnoncees",l:"Normes annoncées",t:"text",groupe:"Technique"},
  {k:"certificatsDisponibles",l:"Certificats disponibles",t:"text",groupe:"Technique"},
  {k:"manuel",l:"Manuel",t:"file",groupe:"Technique"},
  {k:"ficheTechnique",l:"Fiche technique",t:"file",groupe:"Technique"},
  {k:"caracteristiquesPersonnalisees",l:"Caractéristiques personnalisées (ex. \"Tension : 220 V\")",t:"textarea",aide:"Une caractéristique par ligne, format « Champ : Valeur ».",groupe:"Technique"},
  // HS Code & réglementation
  {k:"hsCodeFournisseur",l:"HS Code fourni par le fournisseur",t:"text",groupe:"HS Code & réglementation"},
  {k:"hsCodeUltex",l:"HS Code proposé par ULTEx",t:"text",groupe:"HS Code & réglementation"},
  {k:"statutHsCode",l:"Statut du HS Code",t:"select",opts:STATUTS_HS_CODE,aide:"Un HS Code fourni par le fournisseur n'est pas considéré comme validé tant qu'il n'a pas été vérifié.",groupe:"HS Code & réglementation"},
  {k:"produitReglemente",l:"Produit réglementé",t:"select",opts:["Oui","Non","À vérifier"],groupe:"HS Code & réglementation"},
  {k:"organismesConcernes",l:"Organismes concernés (ONSSA, ANRT, IMANOR, COC, MCIA…)",t:"text",groupe:"HS Code & réglementation"},
  {k:"licenceRequise",l:"Licence requise",t:"select",opts:["Oui","Non","À vérifier"],groupe:"HS Code & réglementation"},
  {k:"etiquetageRequis",l:"Étiquetage requis",t:"select",opts:["Oui","Non","À vérifier"],groupe:"HS Code & réglementation"},
  {k:"msds",l:"Fiche de sécurité MSDS",t:"file",groupe:"HS Code & réglementation"},
  // Exigences client
  {k:"niveauQualite",l:"Niveau de qualité recherché",t:"select",opts:["Économique","Moyen","Premium"],groupe:"Exigences client"},
  {k:"prixVenteSouhaite",l:"Prix de vente souhaité",t:"number",groupe:"Exigences client"},
  {k:"delaiSouhaite",l:"Délai souhaité",t:"text",groupe:"Exigences client"},
  {k:"personnalisation",l:"Personnalisation (logo, marque propre, couleur…)",t:"text",groupe:"Exigences client"},
  {k:"criterePrincipal",l:"Critère principal du client",t:"select",opts:CRITERES_CLIENT_DEMANDE,groupe:"Exigences client"},
  {k:"conditionsParticulieres",l:"Conditions particulières",t:"textarea",groupe:"Exigences client"},
  // Statut
  {k:"statut",l:"Statut de la ligne",t:"select",opts:STATUTS_LIGNE_DEMANDE,groupe:"Statut"}
 ],
 avantSauve: (DB, o) => {
...
dossiers:{label:"Dossiers", ic:FolderKanban, grp:"Commercial", coll:"dossiers", pfx:"DOS", statut:"etape",
 champs:[
  {k:"client",l:"Client existant",t:"ref",coll:"clients",cle:"nom",groupe:"Client & origine"},
  {k:"nouveauClient",l:"…ou nouveau client (nom + tél.)",t:"text",groupe:"Client & origine"},
  {k:"codeClientUltex",l:"Code client ULTEX",t:"text",aide:"Synchronisé automatiquement depuis ULTEX.",groupe:"Client & origine"},
  {k:"typeDemande",l:"Type de demande (ULTEX)",t:"select",opts:["Sourcing (B)","Proforma (A1)","Négociation (A2)"],groupe:"Client & origine"},
  {k:"sensOperation",l:"Sens de l'opération",t:"select",opts:["Import","Export","Accompagnement"],groupe:"Client & origine"},
  {k:"demande",l:"Demande d'origine",t:"ref",coll:"demandes",cle:"code",groupe:"Client & origine"},
  {k:"commande",l:"Commande confirmée",t:"ref",coll:"commandes",cle:"code",groupe:"Client & origine"},
  {k:"creationDirecteAutorisee",l:"Création directe autorisée",t:"text",groupe:"Client & origine"},
  {k:"motifCreationDirecte",l:"Motif de création directe",t:"text",groupe:"Client & origine"},
  {k:"importateurOfficiel",l:"Au nom de qui l'importation sera-t-elle réalisée ?",t:"select",opts:IMPORTATEUR_OFFICIEL_OPTIONS,req:1,aide:"Si « Société du client » : ses informations légales sont récupérées automatiquement depuis sa fiche.",groupe:"Produit & marchandise"},
  {k:"proprietaireMarchandise",l:"Propriétaire de la marchandise",t:"select",opts:PROPRIETAIRES_MARCHANDISE,groupe:"Produit & marchandise"},
  {k:"formuleUltex",l:"Package commercial (raccourci)",t:"select",opts:FORMULES_ULTEX,groupe:"Produit & marchandise"},
  {k:"produit",l:"Produit / Marchandise",t:"text",req:1,groupe:"Produit & marchandise"},
  {k:"quantite",l:"Quantité",t:"text",groupe:"Produit & marchandise"},
  {k:"fournisseur",l:"Fournisseur",t:"ref",coll:"fournisseurs",cle:"nom",groupe:"Produit & marchandise"},
  {k:"fabricantReel",l:"Fabricant réel (si différent du fournisseur)",t:"text",groupe:"Produit & marchandise"},
  {k:"montantVente",l:"Valeur marchandise / vente (MAD)",t:"number",groupe:"Produit & marchandise"},
  {k:"montantAchat",l:"Coût d'achat estimé (MAD)",t:"number",groupe:"Produit & marchandise"},
  {k:"niveauRisqueInitial",l:"Niveau de risque initial (LIMEX)",t:"select",opts:["Faible","Moyen","Élevé","Critique"],groupe:"Produit & marchandise"},
  {k:"incoterm",l:"Incoterm",t:"incoterm",aide:"Règle Incoterms® 2020 qui définit qui du vendeur ou de l'acheteur supporte les frais et risques à chaque étape du transport.",groupe:"Transport & logistique"},
  {k:"paysOrigine",l:"Pays d'origine",t:"pays",groupe:"Transport & logistique"},
  {k:"paysProvenance",l:"Pays de provenance (si différent de l'origine)",t:"pays",groupe:"Transport & logistique"},
  {k:"portDepart",l:"Port / aéroport de départ",t:"port",groupe:"Transport & logistique"},
  {k:"portArrivee",l:"Port / aéroport d'arrivée",t:"port",groupe:"Transport & logistique"},
  {k:"modeTransport",l:"Mode de transport",t:"select",opts:()=>CATEGORIES_TRANSPORT.flatMap(cat=>MODES_TRANSPORT_DETAIL[cat].map(s=>cat+" — "+s)),groupe:"Transport & logistique"},
  {k:"cbm",l:"Volume (CBM)",t:"number",groupe:"Transport & logistique"},
  {k:"poids",l:"Poids brut (kg)",t:"number",groupe:"Transport & logistique"},
  {k:"poidsNet",l:"Poids net (kg)",t:"number",groupe:"Transport & logistique"},
  {k:"tagsPipeline",l:"Tags pipeline ULTEX (Data → Closing)",t:"textarea",aide:"Résumé des tags de disposition ULTEX (Sourcing/Calcul/Closing). Informatif, synchronisé automatiquement.",groupe:"Suivi & statut"},
  {k:"etape",l:"Étape actuelle",t:"select",opts:ETAPES,groupe:"Suivi & statut"},
  {k:"responsable",l:"Responsable du dossier",t:"select",opts:(DB)=>PERS_ET_SERVICES(DB),groupe:"Suivi & statut"},
  {k:"actionSuivante",l:"Action suivante *",t:"text",req:1,groupe:"Suivi & statut"},
  {k:"respActionSuivante",l:"Responsable action suivante *",t:"select",opts:(DB)=>PERS_ET_SERVICES(DB),req:1,groupe:"Suivi & statut"},
  {k:"echeanceActionSuivante",l:"Échéance action suivante *",t:"date",req:1,groupe:"Suivi & statut"},
  {k:"statut",l:"Statut",t:"select",opts:["Actif","Bloqué","Livré","Annulé"],groupe:"Suivi & statut"},
  {k:"remarque",l:"Remarques",t:"textarea",large:1,groupe:"Suivi & statut"}
 ],
 avantSauve: (DB, o, ctx) => {
...
arrivages:{label:"Arrivages", ic:Anchor, grp:"LIMEX", coll:"arrivages", pfx:"ARR", statut:"statut",
 champs:[
  ...
  {k:"nomClientSource",l:"Nom du client source",t:"text"},
  {k:"produitSource",l:"Produit source",t:"text"},
  {k:"incotermSource",l:"Incoterm source",t:"text"},
  {k:"serviceSource",l:"Service source",t:"text"},
  {k:"dateConfirmationSource",l:"Date de confirmation client",t:"date"},
  {k:"totalImporteSource",l:"Total importé source",t:"text"},
  {k:"dateEngagementSource",l:"Date d'engagement",t:"date"},
  {k:"datePaiementSource",l:"Date de paiement",t:"date"},
  {k:"modePaiementSource",l:"Mode de paiement source",t:"text"},
  {k:"numeroProformaSource",l:"N° facture proforma",t:"text"},
  {k:"volumePoidsSource",l:"CBM / poids source",t:"text"},
  {k:"compagnieSource",l:"Compagnie source",t:"text"},
  {k:"offreTransportSource",l:"Offre transport source",t:"text"},
