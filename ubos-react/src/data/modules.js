...
clients:{label:"Clients", ic:Building2, grp:"Commercial", coll:"clients", pfx:"C", statut:"segment",
 champs:[
  ...
  {k:"segment",l:"Segment",t:"select",opts:["Prospect","Client","Client récurrent","Client VIP","Inactif"],groupe:"Suivi commercial"},
  {k:"responsableCommercial",l:"Responsable commercial",t:"select",opts:(DB)=>PERS_ET_SERVICES(DB),groupe:"Suivi commercial"},
  {k:"etapePipeline",l:"Étape du pipeline",t:"select",opts:PIPELINE_ETAPES_CLIENT,groupe:"Suivi commercial"},
  {k:"dernierContact",l:"Dernier contact",t:"date",groupe:"Suivi commercial"},
  {k:"actionSuivante",l:"Action suivante",t:"text",groupe:"Suivi commercial"},
  {k:"respActionSuivante",l:"Responsable de l'action suivante",t:"select",opts:(DB)=>PERS_ET_SERVICES(DB),groupe:"Suivi commercial"},
  {k:"echeanceActionSuivante",l:"Échéance / prochaine relance",t:"date",groupe:"Suivi commercial"},
  {k:"remarque",l:"Remarques",t:"textarea",large:1,groupe:"Suivi commercial"}
 ],
