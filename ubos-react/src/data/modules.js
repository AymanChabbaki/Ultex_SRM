...
clients:{label:"Clients", ic:Building2, grp:"Commercial", coll:"clients", pfx:"C", statut:"segment",
 champs:[
  ...
  {k:"codeClientUltex",l:"Code client ULTEX",t:"text",aide:"Code global attribué par ULTEX à ce client (ex. A201), partagé par tous ses dossiers. Synchronisé automatiquement, ne pas modifier manuellement."},
...
demandes:{label:"Demandes", ic:ClipboardEdit, grp:"Commercial", coll:"demandes", pfx:"DMD", statut:"statut",
 champs:[
  ...
  {k:"codeClientUltex",l:"Code client ULTEX",t:"text",aide:"Synchronisé automatiquement depuis ULTEX."},
  {k:"typeDemande",l:"Type de demande (ULTEX)",t:"select",opts:["Sourcing (B)","Proforma (A1)","Négociation (A2)"]},
  {k:"sensOperation",l:"Sens de l'opération",t:"select",opts:["Import","Export","Accompagnement"]},
...
dossiers:{label:"Dossiers", ic:FolderKanban, grp:"Commercial", coll:"dossiers", pfx:"DOS", statut:"etape",
 champs:[
  ...
  {k:"typeDemande",l:"Type de demande (ULTEX)",t:"select",opts:["Sourcing (B)","Proforma (A1)","Négociation (A2)"]},
  {k:"sensOperation",l:"Sens de l'opération",t:"select",opts:["Import","Export","Accompagnement"]},
  {k:"tagsPipeline",l:"Tags pipeline ULTEX (Data → Closing)",t:"textarea",aide:"Résumé des tags de disposition ULTEX (Sourcing/Calcul/Closing). Informatif, synchronisé automatiquement."},
  {k:"demande",l:"Demande d'origine",t:"ref",coll:"demandes",cle:"code"},
